...
const UserCard = ({ onClick }: UserCardProps) =>{
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-xl  w-full sm:w-[280px] md:w-[294px] h-auto sm:h-[208px] mx-auto sm:ml-[100px] overflow-hidden"
    >
      <div className="relative h-20 bg-gradient-to-r from-[#9333EA] to-[#2563EB] ">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/4">
          {user?.profil_picture ? (
            <div className="border-4 border-white rounded-full w-[88px] h-[88px] overflow-hidden shadow-md z-50">
              <Image
